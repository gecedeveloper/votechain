...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        #Agregamos el nuevo bloque a la cadena
    ...
    def new_transaction(self, sender, recipient, amount):
        """
        Crea una nueva transacción que irá en el siguiente bloque minado

        :param sender: <str> Dirección del remitente
        :param recipient: <str> Dirección del que recibe
        :param amount: <int> Cantidad
        :return <int> El índice del bloque que almacenará esta transacción
        """
    ...
    def proof_of_work(self, last_proof):
        ...
        - Encontrar un número p' tal que hash(pp') contenga 4 ceros adelante, donde p
        - es la prueba anterior, y p' es la nueva prueba
    ...
    def valid_proof(last_proof, proof):
        """
        Valida la prueba: El hash(last_proof, proof) contiene 4 zeros adelante?
    ...
    def hash(block):
        """
        Crea un hash SHA-256 de un bloque dado

        :param block: <dict> Block
        :return: <str>
        """
        # Hay que asegurarnos que el diccionario esté ordenado, sino tendremos hashes inconsistentes
